...
class Csedept extends StatefulWidget {
  @override
  _CsedeptState createState() => _CsedeptState();
}

class _CsedeptState extends State<Csedept> with TickerProviderStateMixin {
